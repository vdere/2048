...
namespace u2048
{
    class Game
    {
        ...
        public void DrawGame(Graphics g)
        {
            ...
            DrawTextCenterX(g, "www.vdere.github.io", fFontS2, new SolidBrush(Color.FromArgb(120, 110, 101)), 198, 552);
            DrawTextCenterX(g, "2019", fFontS2, new SolidBrush(Color.FromArgb(120, 110, 101)), 198, 566);
        }
        ...
        public void DrawAbout(Graphics g)
        {
            ...
            DrawTextCenterXWS(g, "Author: Viraj Dere", fFontS, new SolidBrush(Color.FromArgb(255, 10, 10, 10)), new SolidBrush(Color.White), 198, 250);
            DrawTextCenterXWS(g, "Information", fFontS, new SolidBrush(Color.FromArgb(255, 10, 10, 10)), new SolidBrush(Color.White), 198, 290);
            DrawTextCenterXWS(g, "India", fFontS, new SolidBrush(Color.FromArgb(255, 10, 10, 10)), new SolidBrush(Color.White), 198, 310);
            DrawTextCenterXWS(g, "www.vdere.github.io", fFontS, new SolidBrush(Color.FromArgb(255, 10, 10, 10)), new SolidBrush(Color.White), 198, 350);
            DrawTextCenterXWS(g, "2019", fFontS, new SolidBrush(Color.FromArgb(255, 10, 10, 10)), new SolidBrush(Color.White), 198, 370);
        }
